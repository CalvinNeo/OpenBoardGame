...
DEFAULT_CONFIG = {
    ...
    "bot_heuristic_min_lead_deep_candidates": 10,
...
_AI_EXPORTED_FUNCS = (
    ...
    "_choose_lead_play",
    "_find_straight_flush_candidates",
    ...
    "_cards_use_special_material",
    "_response_material_cost",
    "_rank_response_options",
    "_hypergeom_hit_probability",
