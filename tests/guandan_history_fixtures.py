"""Sanitized card faces and public actions from Guandan regression games.
...
FIXTURES = {
    ...
    '546': {'start_player': 'bot2',
     'dealer_team': 'B',
     'level_rank': 2,
     'visible_card': '♥️K',
     'initial_hands': {'calvin': ('♥️2',
                                  '♠️A',
                                  '♥️A',
                                  '♣️A',
                                  '♦️A',
