...
function setGamePanelVisibility(gameType) {
  ...
  const showHotStreak = gameType === "hot_streak";
  ...
  const showKronologic = gameType === "kronologic";
  ...
  if (hotStreakPanel) {
    hotStreakPanel.classList.toggle("hidden", !showHotStreak);
  }
  if (typeof showHotStreakHeaderActions === "function") {
    showHotStreakHeaderActions(showHotStreak);
  }
  if (yahtzeePanel) {
  ...
  if (typeof showLostCodeHeaderActions === "function") {
    showLostCodeHeaderActions(showLostCode);
  }
  if (criminalDancePanel) {
    criminalDancePanel.classList.toggle("hidden", !showCriminalDance);
  }
  if (typeof showCriminalDanceHeaderActions === "function") {
    showCriminalDanceHeaderActions(showCriminalDance);
  }
  if (istanbulPanel) {
  ...
  if (highSocietyPanel) {
    highSocietyPanel.classList.toggle("hidden", !showHighSociety);
  }
  ...
  if (emeraldSkullsPanel) {
    emeraldSkullsPanel.classList.toggle("hidden", !showEmeraldSkulls);
  }
  ...
  if (kronologicPanel) {
    kronologicPanel.classList.toggle("hidden", !showKronologic);
  }
  if (typeof showKronologicHeaderActions === "function") {
    showKronologicHeaderActions(showKronologic);
  }
  if (texasHoldemPanel) {
